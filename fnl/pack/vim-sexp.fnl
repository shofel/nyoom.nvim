...
; TODO extract lisp-filetypes
(vim.api.nvim_create_autocmd ["FileType"]
                             {:pattern ["fennel" "clojure" "lisp" "racket" "scheme"]
                              :callback set-sexp-keys!
                              : group})


; function! sexp_mappings_for_regular_people#map_sexp_wrap(type, target, left, right, pos)
...
; function! sexp_mappings_for_regular_people#sexp_mappings() abort
;   if !exists('g:sexp_loaded')
;     return
;   endif
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cseb', '(', ')', 0)
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cse(', '(', ')', 0)
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cse)', '(', ')', 1)
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cse[', '[', ']', 0)
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cse]', '[', ']', 1)
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cse{', '{', '}', 0)
;   call sexp_mappings_for_regular_people#map_sexp_wrap('e', 'cse}', '{', '}', 1)
